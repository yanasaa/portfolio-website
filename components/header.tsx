                ...
                sm:flex-nowrap sm:gap-5'>
                    {
                        links.map(link => (
                            ...
                            >
                                <Link 
                                className={clsx('w-full flex items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-300 whitespace-nowrap', {
